...
//                    if (!in_array($field['type'], [\dataCategory::TYPE[33]])) {
                        $active = '';
                        if ($field['type'] == 'home') {
                            ...
                            $trees .= '<li><a href="' . $field['redirect_url'] . '" target="_blank" title="' . $field['title'] . '">' . '<div class="text-center">' . $field['fontawesome_icon'] . '</div>' . $field['title'] . '</a>';
                        } else {
